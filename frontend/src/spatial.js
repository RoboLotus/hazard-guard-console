// Unavailable runtime state is deliberately separate from demo fixtures.
export const fallbackSpatialState = {
  source: "waiting", mock: false, transport_live: false,
  map: { map_id: "", frame_id: "map", width: 1, height: 1, resolution: 1, origin_x: 0, origin_y: 0 },
  pose: { available: false, frame_id: "map" },
  poses: {}, trail: [], sensors: [],
  heatmap: { available: false, simulated: false, detections: [] },
};
